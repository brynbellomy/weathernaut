...
var async, cache, cacheFile, cachedDataExistsFor, cachedDataIsNotStaleFor, cachedDataIsValidFor, doAPIRequest, ensureCacheFileExists, fs, getDataFor, handleError, maxCacheAgeInMsec, path, printAstronomicalData, readExistingCache, request, updateCacheFor, url, writeMemoryCacheToDisk;
...
exports.printAstronomicalData = function(_apiKey, _zipcode) {
  var apiKey, zip;
  apiKey = _apiKey;
  zip = _zipcode;
  return getDataFor(zip, function(err, data) {
    if (err != null) {
