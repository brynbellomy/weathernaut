...
(function() {
  ...
  WeathernautStore = (function() {
    ...
    function WeathernautStore(apiKey) {
      ...
      this.cacheFile = path.join(process.env.HOME, '.weathernaut');
    ...
    WeathernautStore.prototype.updateCacheFor = function(service, zipcode, callback) {
      ...
      return this.doAPIRequest(service, zipcode, function(err, dataForZip) {
        var _base, _ref;

        if (err != null) {
          return callback(err);
        }
        if ((_ref = (_base = _this.cache)[service]) == null) {
          _base[service] = {};
        }
    ...
    WeathernautStore.prototype.getDataFor = function(service, zipcode, callback) {
      ...
      if (this.cachedDataIsValidFor(service, zipcode)) {
        ...
        return this.updateCacheFor(service, zipcode, function(err) {
          if (err) {
  ...
  exports.Weathernaut = (function() {
    ...
    Weathernaut.prototype.printAstronomicalDataFor = function(zipcode) {
      ...
      return this.store.getDataFor(Weathernaut.VALID_SERVICES.astronomy, zipcode, function(err, data) {
        if (err != null) {
    ...
    Weathernaut.prototype.printForecastDataFor = function(zipcode, maxDays) {
      ...
      return this.store.getDataFor(Weathernaut.VALID_SERVICES.forecast, zipcode, function(err, data) {
        if (err != null) {
